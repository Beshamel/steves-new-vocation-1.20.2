...
public class VocationResetCommand {
    ...
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher, CommandRegistryAccess registryAccess,
        ...
        dispatcher.register(CommandManager.literal("vocation")
                .then(CommandManager.literal("reset").executes(context -> execute(context))));
    }
    ...
    private static int execute(CommandContext<ServerCommandSource> context) throws CommandSyntaxException {
        ...
        StevesNewVocation.LOGGER.info("Vocation reset euccessfuly !");
