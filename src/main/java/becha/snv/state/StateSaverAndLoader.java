...
public class StateSaverAndLoader extends PersistentState {
    ...
    public NbtCompound writeNbt(NbtCompound nbt) {
        ...
        players.forEach((uuid, playerData) -> {
            ...
            playerNbt.putString("vocation", playerData.vocation.getName());
    ...
    public static StateSaverAndLoader createFromNbt(NbtCompound tag) {
        ...
        playersNbt.getKeys().forEach(key -> {
            ...
            playerData.vocation = Vocations.fromName(playersNbt.getCompound(key).getString("vocation"));
    ...
    private static Type<StateSaverAndLoader> type = new Type<>(
            ...
            StateSaverAndLoader::createFromNbt, // If there is a 'StateSaverAndLoader' NBT, parse it with
                                                // 'createFromNbt'
    ...
    public static StateSaverAndLoader getServerState(MinecraftServer server) {
        ...
        // brand new 'StateSaverAndLoader' and
        // stores it inside the 'PersistentStateManager'. The subsequent calls to
        // 'getOrCreate' pass in the saved
        // 'StateSaverAndLoader' NBT on disk to our function
        // 'StateSaverAndLoader::createFromNbt'.
        StateSaverAndLoader state = persistentStateManager.getOrCreate(type, StevesNewVocation.MOD_ID);
